...
let a = class extends i {
  constructor(...e) {
    (super(...e), (this.headerTitle = t(`Complete Workshop Content`)), (this.sectionId = `*`));
  }
  renderContentPanel() {
    return r`
...
a = e([n(`full-content-demo`)], a);
const o = document.createElement(`full-content-demo`);
document.body.appendChild(o);
export { a as FullContentDemo };
