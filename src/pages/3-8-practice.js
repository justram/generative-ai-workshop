...
let a = class extends i {
  constructor(...e) {
    (super(...e), (this.headerTitle = t(`Chatbots: Key Takeaways`)), (this.sectionId = `3.8`));
  }
  renderContentPanel() {
    return r`
...
((a = e([n(`practice-demo`)], a)), (document.body.innerHTML = `<practice-demo></practice-demo>`));
export { a as PracticeDemo };
