...
let a = class extends i {
  constructor(...e) {
    (super(...e),
      (this.headerTitle = t(`What this workshop is and isn't`)),
      (this.sectionId = `1`),
...
a = e([n(`introduction-demo`)], a);
const o = document.createElement(`introduction-demo`);
document.body.appendChild(o);
export { a as IntroductionDemo };
