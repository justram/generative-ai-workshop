...
let c = class extends t {
  ...
  setMode(e) {
    this.mode !== e &&
      ((this.mode = e),
      this.dispatchEvent(
        new CustomEvent(`mode-change`, { detail: this.mode, bubbles: !0 }),
      ));
  }
  render() {
    let e = this.mode === `preview`;
    return s`
...
(e([a({ reflect: !1 })], c.prototype, `mode`, void 0),
  (c = e([o(`preview-code-toggle`)], c)));
