import { fc as e, i18n as t, x as n } from "../mini-lit/index.js";
const r = e(
    ({
      isOpen: e,
      onClose: r,
      children: i,
      width: a = `min(600px, 90vw)`,
      height: o = `auto`,
      className: s = ``,
    }) =>
      e
        ? n`
		<!-- Backdrop -->
		<div class="fixed inset-0 bg-black/50 z-40" @click=${(e) => {
  ...
  i = e(
    ({ title: e, description: t, className: r = `` }) => n`
		<div class="pr-8 ${r}">
  ...
  a = e(
    ({ children: e, className: t = `` }) =>
      n` <div class="p-6 flex flex-col gap-4 ${t}">${e}</div> `,
  ),
  o = e(
    ({ children: e, className: t = `` }) =>
      n` <div class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end ${t}">${e}</div> `,
  );
export {
  r as Dialog,
  a as DialogContent,
