...
function v({
  ...
  return e({
    ...
    size: `sm`,
    onClick: () => {
      let e = new Blob([t], { type: r }),
        i = URL.createObjectURL(e),
        a = document.createElement(`a`);
      ((a.href = i), (a.download = n), a.click(), URL.revokeObjectURL(i));
    },
    title: a,
    children: f` ${o(`sm`)} ${s ? f`<span>${i(`Download`)}</span>` : ``} `,
  });
}
var y = class extends r {
  constructor(...e) {
    (super(...e), (this.filename = ``), (this.displayTitle = ``));
  }
  createRenderRoot() {
    return this;
  }
...
let b = class extends y {
  constructor(...e) {
    (super(...e),
      ...
      (this._content = ``),
      (this.logs = []),
      (this.iframeContainerRef = n()),
      (this.consoleLogsRef = n()),
      (this.consoleButtonRef = n()),
      (this.viewMode = `preview`),
      (this.consoleOpen = !1),
      (this.handleMessage = (e) => {
        e.data.artifactId === this.filename &&
          (e.data.type === `console`
            ? this.addLog({
                type: e.data.method === `error` ? `error` : `log`,
                text: e.data.text,
              })
            : e.data.type === `execution-complete` &&
  ...
  addLog(e) {
    if (
      (this.logs.push(e),
      this.updateConsoleButton(),
      this.consoleOpen && this.consoleLogsRef.value)
    ) {
      let t = document.createElement(`div`);
      ((t.className = `text-xs font-mono ${e.type === `error` ? `text-destructive` : `text-muted-foreground`}`),
        (t.textContent = `[${e.type}] ${e.text}`),
        this.consoleLogsRef.value.appendChild(t));
    }
  }
  updateConsoleButton() {
    let e = this.consoleButtonRef.value;
    if (!e) return;
    let t = this.logs.filter((e) => e.type === `error`).length;
    e.innerHTML = `<span>${t > 0 ? `${i(`console`)} <span class="text-destructive">${i(`({count} errors)`)(t)}</span>` : `${i(`console`)} ${i(`({count})`)(this.logs.length)}`}</span><span>${this.consoleOpen ? `▼` : `▶`}</span>`;
  }
  updateIframe() {
    if ((this.iframe || this.createIframe(), this.iframe)) {
      ((this.logs = []),
        this.consoleLogsRef.value && (this.consoleLogsRef.value.innerHTML = ``),
        this.updateConsoleButton());
      let e = `
				<script>
				(function() {
        ...
        r = `
			...
			`;
      ((n = n.match(/<head[^>]*>/i)
        ? n.replace(/<head[^>]*>/i, (t) => `${t}${r}${e}`)
        : r + e + n),
        n.match(/<\/body>/i)
          ? (n = n.replace(/<\/body>/i, `${t}</body>`))
          : (n += t),
        (this.iframe.srcdoc = n));
    }
  }
  createIframe() {
    (this.iframe ||
  ...
  attachIframeToContainer() {
    !this.iframe ||
      !this.iframeContainerRef.value ||
      (this.iframe.parentElement !== this.iframeContainerRef.value &&
  ...
  getLogs() {
    return this.logs.length === 0
      ? i(`No logs for {filename}`)(this.filename)
      : this.logs.map((e) => `[${e.type}] ${e.text}`).join(`
`);
  }
  render() {
    return f`
									...
									<div class="border-t border-border">
										...
										>
											<span
												>${i(`console`)}
												${
                          this.logs.filter((e) => e.type === `error`).length > 0
                            ? f`<span class="text-destructive"
															>${i(`({count} errors)`)(this.logs.filter((e) => e.type === `error`).length)}</span
														>`
                            : i(`({count})`)(this.logs.length)
                        }</span
											>
...
(t([c()], b.prototype, `filename`, void 0),
  t([c({ attribute: !1 })], b.prototype, `displayTitle`, void 0),
  t([c({ attribute: !1 })], b.prototype, `attachments`, void 0),
  t([u()], b.prototype, `viewMode`, void 0),
  t([u()], b.prototype, `consoleOpen`, void 0),
  (b = t([d(`html-artifact`)], b)));
let x = class extends y {
  ...
  set content(e) {
    ((this._content = e), this.requestUpdate());
  }
  createRenderRoot() {
    return this;
  }
...
(t([c()], x.prototype, `filename`, void 0),
  t([c({ attribute: !1 })], x.prototype, `displayTitle`, void 0),
  t([u()], x.prototype, `viewMode`, void 0),
  (x = t([d(`markdown-artifact`)], x)));
    ...
    return f`
			<div class="h-full flex flex-col">
				<div class="flex-1 overflow-auto">
					${
            this.viewMode === `preview`
              ? f`<div class="h-full flex items-center justify-center">
								${l(this.content.replace(/<svg(\s|>)/i, (e, t) => `<svg class="w-full h-full"${t}`))}
							</div>`
              : f`<pre class="m-0 p-4 text-xs"><code class="hljs language-xml">${l(p.highlight(this.content, { language: `xml`, ignoreIllegals: !0 }).value)}</code></pre>`
          }
				</div>
			</div>
		`;
...
(t([c()], S.prototype, `filename`, void 0),
  t([c({ attribute: !1 })], S.prototype, `displayTitle`, void 0),
  t([u()], S.prototype, `viewMode`, void 0),
  (S = t([d(`svg-artifact`)], S)));
const C =
  `js.javascript.ts.typescript.jsx.tsx.py.python.java.c.cpp.cs.php.rb.ruby.go.rust.swift.kotlin.scala.dart.html.css.scss.sass.less.json.xml.yaml.yml.toml.sql.sh.bash.ps1.bat.r.matlab.julia.lua.perl.vue.svelte`.split(
    `.`,
  );
let w = class extends y {
  ...
  isCode() {
    let e = this.filename.split(`.`).pop()?.toLowerCase() || ``;
    return C.includes(e);
  }
  getLanguageFromExtension(e) {
    return (
      {
        js: `javascript`,
        ts: `typescript`,
...
(t([c()], w.prototype, `filename`, void 0),
  t([c({ attribute: !1 })], w.prototype, `displayTitle`, void 0),
  (w = t([d(`text-artifact`)], w)));
const T = h.Object({
  command: m([`create`, `update`, `rewrite`, `get`, `delete`, `logs`], {
    description: `The operation to perform`,
  }),
  filename: h.String({
    description: `Filename including extension (e.g., 'index.html', 'script.js')`,
  }),
  content: h.Optional(h.String({ description: `File content` })),
  old_str: h.Optional(
    h.String({ description: `String to replace (for update command)` }),
  ),
  new_str: h.Optional(
    h.String({ description: `Replacement string (for update command)` }),
  ),
});
function E(e) {
  return f`<div class="text-xs text-muted-foreground whitespace-pre-wrap font-mono">${e}</div>`;
}
let D = class extends r {
    ...
    (super.connectedCallback(),
      ...
      requestAnimationFrame(() => {
        ...
        e &&
          ...
          this.artifactElements.forEach((t, n) => {
            (t.parentElement || e.appendChild(t),
              (t.style.display =
                n === this._activeFilename ? `block` : `none`));
          }));
      }));
  }
  disconnectedCallback() {
  ...
  getOrCreateArtifactElement(e, t, n) {
    let r = this.artifactElements.get(e);
    if (r)
      ((r.content = t),
        (r.displayTitle = n),
        r instanceof b && (r.attachments = this.attachmentsProvider?.() || []));
    else {
      let i = this.getFileType(e);
      (i === `html`
        ? ((r = new b()), (r.attachments = this.attachmentsProvider?.() || []))
        : (r = i === `svg` ? new S() : i === `markdown` ? new x() : new w()),
        (r.filename = e),
        (r.displayTitle = n),
        (r.content = t),
        (r.style.display = `none`),
        (r.style.height = `100%`),
        this.artifactElements.set(e, r));
      let a = r;
      requestAnimationFrame(() => {
        this.contentRef.value &&
          !a.parentElement &&
          this.contentRef.value.appendChild(a);
      });
    }
    return r;
  }
  showArtifact(e) {
    (requestAnimationFrame(() => {
      this.artifactElements.forEach((t, n) => {
        (this.contentRef.value &&
          !t.parentElement &&
          this.contentRef.value.appendChild(t),
          (t.style.display = n === e ? `block` : `none`));
      });
    }),
      (this._activeFilename = e),
      this.requestUpdate());
  }
  openArtifact(e) {
    this._artifacts.has(e) && (this.showArtifact(e), this.onOpen?.());
  }
  get tool() {
    return {
      label: `Artifacts`,
...
- Can embed raster images as base64 in SVG`,
      parameters: T,
      execute: async (e, t, n) => ({
        output: await this.executeCommand(t),
        details: void 0,
      }),
    };
  }
  renderParams(e, t) {
    if (t && !e.command)
      return f`<div class="text-sm text-muted-foreground">${i(`Processing artifact...`)}</div>`;
    let n = i(`Processing`);
    if (e.command)
      switch (e.command) {
        case `create`:
        ...
        case `logs`:
          ...
          break;
        default:
          n = e.command.charAt(0).toUpperCase() + e.command.slice(1);
      }
    let r = e.filename || ``;
    switch (e.command) {
      case `create`:
  ...
  async reconstructFromMessages(e) {
    let t = new Map(),
      n = `artifacts`;
    for (let r of e)
      if (r.role === `assistant`)
        for (let e of r.content)
          e.type === `toolCall` && e.name === n && t.set(e.id, e);
    let r = [];
    for (let i of e)
      if (i.role === `toolResult` && i.toolName === n && !i.isError) {
        let e = i.toolCallId,
          n = t.get(e);
        if (!n) continue;
        let a = n.arguments;
    ...
    for (let e of r) {
      ...
      switch (e.command) {
        case `create`:
          e.content && i.set(t, { filename: t, content: e.content });
          break;
        case `rewrite`:
          e.content && i.set(t, { filename: t, content: e.content });
          break;
        case `update`: {
          ...
          e.old_str !== void 0 &&
            e.new_str !== void 0 &&
            ((n.content = n.content.replace(e.old_str, e.new_str)),
            i.set(t, n));
          break;
        }
        case `delete`:
    ...
    (this._artifacts.clear(),
      this.artifactElements.forEach((e) => {
        e.remove();
      }),
      this.artifactElements.clear(),
      (this._activeFilename = null),
      (this._artifacts = new Map(this._artifacts)));
    for (let [e, { content: t }] of i.entries()) {
      let n = { command: `create`, filename: e, content: t };
      try {
        await this.createArtifact(n, { skipWait: !0, silent: !0 });
      } catch {}
    }
    (!this._activeFilename &&
      this._artifacts.size > 0 &&
  ...
  async executeCommand(e, t = {}) {
    switch (e.command) {
      case `create`:
        return await this.createArtifact(e, t);
      case `update`:
        return await this.updateArtifact(e, t);
      case `rewrite`:
        return await this.rewriteArtifact(e, t);
      case `get`:
        return this.getArtifact(e);
      case `delete`:
        return this.deleteArtifact(e);
      case `logs`:
        return this.getLogs(e);
      default:
        return i(`Error: Unknown command {command}`)(e.command);
    }
  }
  async waitForHtmlExecution(e) {
    let t = this.artifactElements.get(e);
    return t instanceof b
      ? new Promise((n) => {
          let r = !1,
            a = (o) => {
              if (
                o.data?.type === `execution-complete` &&
                o.data?.artifactId === e &&
                !r
              ) {
                ((r = !0), window.removeEventListener(`message`, a));
                let o = t.getLogs();
                o.includes(`[error]`)
                  ? n(
                      i(`
...
{logs}`)(o),
  ...
  async createArtifact(e, t = {}) {
    if (!e.filename || !e.content)
      return i(`Error: create command requires filename and content`);
    if (this._artifacts.has(e.filename))
      return i(`Error: File {filename} already exists`)(e.filename);
    let n = e.filename,
      r = {
        filename: e.filename,
        title: n,
    ...
    (this._artifacts.set(e.filename, r),
      (this._artifacts = new Map(this._artifacts)),
      this.getOrCreateArtifactElement(e.filename, e.content, n),
      t.silent ||
        (this.showArtifact(e.filename),
        this.onArtifactsChange?.(),
        this.requestUpdate()));
    let a = i(`Created file {filename}`)(e.filename);
    if (this.getFileType(e.filename) === `html` && !t.skipWait) {
      let t = await this.waitForHtmlExecution(e.filename);
      a += t;
    }
    return a;
  }
  async updateArtifact(e, t = {}) {
    let n = this._artifacts.get(e.filename);
    if (!n) {
      let t = Array.from(this._artifacts.keys());
      return t.length === 0
        ? i(
            `Error: File {filename} not found. No files have been created yet.`,
          )(e.filename)
        : i(`Error: File {filename} not found. Available files: {files}`)(
            e.filename,
            t.join(`, `),
          );
    }
    if (!e.old_str || e.new_str === void 0)
      return i(`Error: update command requires old_str and new_str`);
    if (!n.content.includes(e.old_str))
      return i(`Error: String not found in file. Here is the full content:

{content}`)(n.content);
    ((n.content = n.content.replace(e.old_str, e.new_str)),
      (n.updatedAt = new Date()),
      this._artifacts.set(e.filename, n),
      this.getOrCreateArtifactElement(e.filename, n.content, n.title),
      t.silent ||
        (this.onArtifactsChange?.(),
        this.requestUpdate(),
        this.requestUpdate()));
    let r = i(`Updated file {filename}`)(e.filename);
    if (this.getFileType(e.filename) === `html` && !t.skipWait) {
      let t = await this.waitForHtmlExecution(e.filename);
      r += t;
    }
  ...
  async rewriteArtifact(e, t = {}) {
    ...
    if (!e.content) return i(`Error: rewrite command requires content`);
    ((n.content = e.content),
      (n.updatedAt = new Date()),
      this._artifacts.set(e.filename, n),
      this.getOrCreateArtifactElement(e.filename, n.content, n.title),
      t.silent || this.onArtifactsChange?.());
    let r = i(`Rewrote file {filename}`)(e.filename);
    if (this.getFileType(e.filename) === `html` && !t.skipWait) {
      let t = await this.waitForHtmlExecution(e.filename);
      r += t;
    }
  ...
  getArtifact(e) {
    let t = this._artifacts.get(e.filename);
    if (!t) {
      let t = Array.from(this._artifacts.keys());
      return t.length === 0
        ? i(
  ...
  deleteArtifact(e) {
    if (!this._artifacts.get(e.filename)) {
      let t = Array.from(this._artifacts.keys());
      return t.length === 0
        ? i(
            `Error: File {filename} not found. No files have been created yet.`,
    ...
    (this._artifacts.delete(e.filename),
      (this._artifacts = new Map(this._artifacts)));
    let t = this.artifactElements.get(e.filename);
    if (
      (t && (t.remove(), this.artifactElements.delete(e.filename)),
      this._activeFilename === e.filename)
    ) {
      let e = Array.from(this._artifacts.keys());
      e.length > 0
        ? this.showArtifact(e[0])
        : ((this._activeFilename = null), this.requestUpdate());
    }
    return (
      this.onArtifactsChange?.(),
      this.requestUpdate(),
      i(`Deleted file {filename}`)(e.filename)
    );
  }
  getLogs(e) {
    let t = this.artifactElements.get(e.filename);
  ...
  render() {
    let t = Array.from(this._artifacts.values()),
      n = t.length > 0 && !this.collapsed;
    return f`
			<!-- Floating reopen pill when collapsed and artifacts exist -->
			${
        this.collapsed && t.length > 0
          ? f`
						<button
			...
			>
				...
				<div class="flex items-center justify-between border-b border-border bg-muted/50">
					<div class="flex overflow-x-auto">
						${t.map((e) => {
              let t =
                e.filename === this._activeFilename
              ...
              return f`
					...
					<div class="flex items-center gap-1 px-2">
						${(() => {
              let e = this._activeFilename
                ? this.artifactElements.get(this._activeFilename)
                : void 0;
              return e ? e.getHeaderButtons() : ``;
            })()}
...
(t([u()], D.prototype, `_artifacts`, void 0),
  t([u()], D.prototype, `_activeFilename`, void 0),
  t([c({ attribute: !1 })], D.prototype, `attachmentsProvider`, void 0),
  t([c({ attribute: !1 })], D.prototype, `onArtifactsChange`, void 0),
  t([c({ attribute: !1 })], D.prototype, `onClose`, void 0),
  t([c({ attribute: !1 })], D.prototype, `onOpen`, void 0),
  t([c({ type: Boolean })], D.prototype, `collapsed`, void 0),
  t([c({ type: Boolean })], D.prototype, `overlay`, void 0),
  (D = t([d(`artifacts-panel`)], D)));
export { D as ArtifactsPanel };
